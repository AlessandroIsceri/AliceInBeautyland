...
<head>
    ...
    <title>Elimina un trattamento</title>
      ...
      <br>
        <?php
            ...
            else if(isset($_POST['seleziona']))//se e' stato cliccato il pulsante di un prodotto
            {
                ...
                $prezzo = $riga['prezzo'];
                $durata = $riga['durata'];
                //stampo il form per eliminare i dati
                echo '
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col">
                        <input type="text" class="form-control" placeholder="Nome trattamento" name="nome" id="nome" value="'.$nomeTrattamento.'" readonly>
                        </div>
                        <div class="col">
                    ...
                    <div class="row">
                        <div class="col">
                        <input type="time" class="form-control" name="durata" id="durata" value="'.$durata.'" readonly>
                        </div>
                    </div>
                    <br><br>
                    <br>
                ...
                echo'   </div>
                    ...
                    <div style="text-align:center">
                        ...
                        <div class="col-md-3 my-3 mx-auto">
                            <button class="btn btn-dark bottoneHome" type="submit" value="'.$codTrattamento.'" name="elimina">Elimina</button>
                        </div>
                        <div class="col-md-3 my-3 mx-auto">
            ...
            else //inviato il form di elimina
            {
                ...
                $query = "DELETE FROM trattamento WHERE codTrattamento = $codTrattamento";
                //echo $query;
                ...
                echo '<div class="col-6 mx-auto" style="text-align:center"><a href="./elimina.php"><button class="btn btn-dark bottoneHome" type="button">Elimina un altro trattamento</button></a></div>';
